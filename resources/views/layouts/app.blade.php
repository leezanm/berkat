    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container">
            <a class="navbar-brand" href="{{ url('/') }}">
                <i class="fas fa-handshake"></i> <strong>BERKAT</strong> - Sistem Permohonan Bantuan
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    @else
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('login') }}">Log Masuk Sistem</a>
                        </li>
                    @endauth
                </ul>
            </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4 mb-4">
                    ...
                    <p>
                        Email: <a href="mailto:berkat@example.com">berkat@example.com</a><br>
